...
- `summarization_limit_reset` (DateTimeField) - Limit reset timestamp (default=now)
...
- `streak_updated_at` (DateTimeField) - Streak last update (default=now)
...
- `date_joined` (DateTimeField) - Django date joined (default=now)
...
- `created_at` (DateTimeField) - Creation timestamp, indexed (default=now)
...
- `created_at` (DateTimeField) - Creation timestamp (default=now)
...
- `created_at` (DateTimeField) - Statistics date/timestamp, indexed (default=now)
...
- `created_at` (DateTimeField) - Request creation timestamp, indexed (default=now)
...
- `last_active_at` (DateTimeField) - Last active timestamp (default=now)
- `created_at` (DateTimeField) - Device registration timestamp (default=now)
...
- `last_used_at` (DateTimeField) - Last token usage timestamp (default=now)
- `created_at` (DateTimeField) - Session creation timestamp (default=now)
...
- `created_at` (DateTimeField) - Summary creation timestamp (default=now)
...
- `created_at` (DateTimeField) - Waitlist entry timestamp (default=now)
...
- `created_at` (DateTimeField) - Event timestamp, indexed (default=now)
...
- `created_at` (DateTimeField) - Connection timestamp (default=now)
- `updated_at` (DateTimeField) - Last update timestamp (auto_now=True)
...
- `last_run_at` (DateTimeField) - Last sync run timestamp (default=now)
...
- `connected_at` (DateTimeField) - Connection timestamp (default=now)
...
- `created_at` (DateTimeField) - Render timestamp, indexed (default=now)
...
- `created_at` (DateTimeField) - Interaction timestamp, indexed (default=now)
...
- `created_at` (DateTimeField) - Event timestamp (default=now)
...
- `requested_at` (DateTimeField) - Request timestamp, indexed (default=now)
...
- `on_delete=CASCADE` - Deletion behavior (CASCADE, SET_NULL, PROTECT, etc.)
