...
Get newsletter recommendations (requires authentication).
...
Search newsletters preview (quick search, limited results).
  ...
  "results": [
    {
      "id": "uuid",
      "name": "Technology",
      "preview": "Tech-related newsletters"
    }
  ]
}
```
...
Search newsletters in a category (preview).
